...
import eu.leads.infext.datastore.datastruct.Cell;
import eu.leads.infext.datastore.datastruct.URIVersion;
...
public abstract class AbstractDataStore {
	 ...
	 * @param beforeTimestamp - if we want versions before some version, give this version's day (can be null)
	 * 
	 * @return set of versions of URI family, starting with the freshest one (descending day), if none - returns an empty set
	 */
	 ...
	 * @param ts - day of URI for which new data should be stored
