...
public class Functionality1A {
	...
	static public class Functionality1AParams {
	...
	static public class Functionality1AReturnRow implements Comparable<Functionality1AReturnRow> {
	...
	public SortedSet<Functionality1AReturnRow> execute(Functionality1AParams params) {
		SortedSet<Functionality1AReturnRow> resultsSet = new TreeSet<>();
	...
	public static void main(String[] args) {
		...
		SortedSet<Functionality1AReturnRow> rows = func1A.execute(params);
		int i=0;
