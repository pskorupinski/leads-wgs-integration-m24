...
public class Functionality2 {
	...
	static public class Functionality2Params {
	...
	static public class Functionality2ResultRow implements Comparable<Functionality2ResultRow> {
	...
	public SortedSet<Functionality2ResultRow> execute(Functionality2Params params) {
		SortedSet<Functionality2ResultRow> resultsSet = new TreeSet<>();
	...
	public static void main(String[] args) {
		...
		Set<Functionality2ResultRow> rows = func2.execute(params);
		int i=0;
